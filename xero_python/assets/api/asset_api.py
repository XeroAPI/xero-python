...
class AssetApi(object):
    ...
    def create_asset(self, xero_tenant_id, asset,  _return_http_data_only=True, _preload_content=True, _request_timeout=None):
        ...
        if asset is None:
            raise ValueError("Missing the required parameter `asset` "
                             "when calling `create_asset`")
    ...
    def create_asset_type(self, xero_tenant_id, asset_type=empty,  _return_http_data_only=True, _preload_content=True, _request_timeout=None):
    ...
    def get_asset_by_id(self, xero_tenant_id, id,  _return_http_data_only=True, _preload_content=True, _request_timeout=None):
    ...
    def get_asset_settings(self, xero_tenant_id,  _return_http_data_only=True, _preload_content=True, _request_timeout=None):
    ...
    def get_asset_types(self, xero_tenant_id,  _return_http_data_only=True, _preload_content=True, _request_timeout=None):
    ...
    def get_assets(self, xero_tenant_id, status, page=empty, page_size=empty, order_by=empty, sort_direction=empty, filter_by=empty,  _return_http_data_only=True, _preload_content=True, _request_timeout=None):
        ...
        if status is None:
            raise ValueError("Missing the required parameter `status` "
                             "when calling `get_assets`")
