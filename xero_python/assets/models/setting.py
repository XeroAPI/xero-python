...
class Setting(BaseModel):
    ...
    def __init__(self, asset_number_prefix=None, asset_number_sequence=None, asset_start_date=None, last_depreciation_date=None, default_gain_on_disposal_account_id=None, default_loss_on_disposal_account_id=None, default_capital_gain_on_disposal_account_id=None, opt_in_for_tax=None):  # noqa: E501
