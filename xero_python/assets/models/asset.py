...
class Asset(BaseModel):
    ...
    def __init__(self, asset_id=None, asset_name=None, asset_type_id=None, asset_number=None, purchase_date=None, purchase_price=None, disposal_date=None, disposal_price=None, asset_status=None, warranty_expiry_date=None, serial_number=None, book_depreciation_setting=None, book_depreciation_detail=None, can_rollback=None, accounting_book_value=None, is_delete_enabled_for_date=None):  # noqa: E501
