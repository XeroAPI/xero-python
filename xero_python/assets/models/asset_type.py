...
class AssetType(BaseModel):
    ...
    def __init__(self, asset_type_id=None, asset_type_name=None, fixed_asset_account_id=None, depreciation_expense_account_id=None, accumulated_depreciation_account_id=None, book_depreciation_setting=None, locks=None):  # noqa: E501
    ...
    def asset_type_name(self, asset_type_name):
        ...
        if asset_type_name is None:
            raise ValueError("Invalid value for `asset_type_name`, must not be `None`")  # noqa: E501
    ...
    def book_depreciation_setting(self, book_depreciation_setting):
        ...
        if book_depreciation_setting is None:
            raise ValueError("Invalid value for `book_depreciation_setting`, must not be `None`")  # noqa: E501
