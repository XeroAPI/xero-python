...
class BookDepreciationDetail(BaseModel):
    ...
    def __init__(self, current_capital_gain=None, current_gain_loss=None, depreciation_start_date=None, cost_limit=None, residual_value=None, prior_accum_depreciation_amount=None, current_accum_depreciation_amount=None):  # noqa: E501
