...
class BookDepreciationSetting(BaseModel):
    ...
    def __init__(self, depreciation_method=None, averaging_method=None, depreciation_rate=None, effective_life_years=None, depreciation_calculation_method=None, depreciable_object_id=None, depreciable_object_type=None, book_effective_date_of_change_id=None):  # noqa: E501
    ...
    def depreciation_method(self, depreciation_method):
        ...
        :type: str
        """
        allowed_values = ["NoDepreciation", "StraightLine", "DiminishingValue100", "DiminishingValue150", "DiminishingValue200", "FullDepreciation", "None"]  # noqa: E501
        
        if depreciation_method:
            if depreciation_method not in allowed_values:
                raise ValueError(
                    "Invalid value for `depreciation_method` ({0}), must be one of {1}"  # noqa: E501
    ...
    def averaging_method(self, averaging_method):
        ...
        if averaging_method:
            if averaging_method not in allowed_values:
                raise ValueError(
                    "Invalid value for `averaging_method` ({0}), must be one of {1}"  # noqa: E501
    ...
    def depreciation_calculation_method(self, depreciation_calculation_method):
        ...
        if depreciation_calculation_method:
            if depreciation_calculation_method not in allowed_values:
                raise ValueError(
                    "Invalid value for `depreciation_calculation_method` ({0}), must be one of {1}"  # noqa: E501
