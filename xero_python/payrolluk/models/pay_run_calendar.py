...
class PayRunCalendar(BaseModel):
    ...
    def __init__(self, payroll_calendar_id=None, name=None, calendar_type=None, period_start_date=None, period_end_date=None, payment_date=None, updated_date_utc=None):  # noqa: E501
