...
class SalaryAndWage(BaseModel):
    ...
    def __init__(self, salary_and_wages_id=None, earnings_rate_id=None, number_of_units_per_week=None, rate_per_unit=None, number_of_units_per_day=None, effective_from=None, annual_salary=None, status=None, payment_type=None):  # noqa: E501
