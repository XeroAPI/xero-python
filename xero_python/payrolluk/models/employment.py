...
class Employment(BaseModel):
    ...
    def __init__(self, payroll_calendar_id=None, start_date=None, employee_number=None, ni_category=None):  # noqa: E501
    ...
    def ni_category(self, ni_category):
        ...
        if ni_category:
            if ni_category not in allowed_values:
                raise ValueError(
                    "Invalid value for `ni_category` ({0}), must be one of {1}"  # noqa: E501
                    .format(ni_category, allowed_values)
            )
