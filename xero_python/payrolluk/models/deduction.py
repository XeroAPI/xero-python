...
class Deduction(BaseModel):
    ...
    def __init__(self, deduction_id=None, deduction_name=None, deduction_category=None, liability_account_id=None, current_record=None, standard_amount=None, reduces_super_liability=None, reduces_tax_liability=None, calculation_type=None, percentage=None, subject_to_nic=None, subject_to_tax=None, is_reduced_by_basic_rate=None, apply_to_pension_calculations=None, is_calculating_on_qualifying_earnings=None, is_pension=None):  # noqa: E501
    ...
    def deduction_name(self, deduction_name):
        ...
        if deduction_name is None:
            raise ValueError("Invalid value for `deduction_name`, must not be `None`")  # noqa: E501
    ...
    def deduction_category(self, deduction_category):
        ...
        :type: str
        """
        allowed_values = ["CapitalContributions", "ChildCareVoucher", "MakingGood", "PostgraduateLoanDeductions", "PrivateUsePayments", "SalarySacrifice", "StakeholderPension", "StakeholderPensionPostTax", "StudentLoanDeductions", "UkOther", "None"]  # noqa: E501
        
        if deduction_category:
            if deduction_category not in allowed_values:
                raise ValueError(
                    "Invalid value for `deduction_category` ({0}), must be one of {1}"  # noqa: E501
    ...
    def liability_account_id(self, liability_account_id):
        ...
        if liability_account_id is None:
            raise ValueError("Invalid value for `liability_account_id`, must not be `None`")  # noqa: E501
