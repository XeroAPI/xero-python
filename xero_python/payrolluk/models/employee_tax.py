...
class EmployeeTax(BaseModel):
    ...
    def __init__(self, starter_type=None, starter_declaration=None, tax_code=None, w1_m1=None, previous_taxable_pay=None, previous_tax_paid=None, student_loan_deduction=None, has_post_graduate_loans=None, is_director=None, directorship_start_date=None, nic_calculation_method=None):  # noqa: E501
