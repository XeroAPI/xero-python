...
class EarningsRate(BaseModel):
    ...
    def __init__(self, earnings_rate_id=None, name=None, earnings_type=None, rate_type=None, type_of_units=None, current_record=None, expense_account_id=None, rate_per_unit=None, multiple_of_ordinary_earnings_rate=None, fixed_amount=None):  # noqa: E501
    ...
    def earnings_type(self, earnings_type):
        ...
        if earnings_type is None:
            raise ValueError("Invalid value for `earnings_type`, must not be `None`")  # noqa: E501
        allowed_values = ["Allowance", "Backpay", "Bonus", "Commission", "LumpSum", "OtherEarnings", "OvertimeEarnings", "RegularEarnings", "StatutoryAdoptionPay", "StatutoryAdoptionPayNonPensionable", "StatutoryBereavementPay", "StatutoryMaternityPay", "StatutoryMaternityPayNonPensionable", "StatutoryPaternityPay", "StatutoryPaternityPayNonPensionable", "StatutoryParentalBereavementPayNonPensionable", "StatutorySharedParentalPay", "StatutorySharedParentalPayNonPensionable", "StatutorySickPay", "StatutorySickPayNonPensionable", "Tips(Direct)", "Tips(Non-Direct)", "TerminationPay", "None"]  # noqa: E501
        
        if earnings_type:
            if earnings_type not in allowed_values:
                raise ValueError(
                    "Invalid value for `earnings_type` ({0}), must be one of {1}"  # noqa: E501
                    .format(earnings_type, allowed_values)
            )
    ...
    def rate_type(self, rate_type):
        ...
        allowed_values = ["RatePerUnit", "MultipleOfOrdinaryEarningsRate", "FixedAmount", "None"]  # noqa: E501
    ...
    def type_of_units(self, type_of_units):
        ...
        if type_of_units is None:
            raise ValueError("Invalid value for `type_of_units`, must not be `None`")  # noqa: E501
    ...
    def expense_account_id(self, expense_account_id):
        ...
        if expense_account_id is None:
            raise ValueError("Invalid value for `expense_account_id`, must not be `None`")  # noqa: E501
