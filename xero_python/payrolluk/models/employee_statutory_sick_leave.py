...
class EmployeeStatutorySickLeave(BaseModel):
    ...
    def work_pattern(self, work_pattern):
        ...
        if work_pattern is None:
            raise ValueError("Invalid value for `work_pattern`, must not be `None`")  # noqa: E501
    ...
    def is_pregnancy_related(self, is_pregnancy_related):
        ...
        if is_pregnancy_related is None:
            raise ValueError("Invalid value for `is_pregnancy_related`, must not be `None`")  # noqa: E501
    ...
    def sufficient_notice(self, sufficient_notice):
        ...
        if sufficient_notice is None:
            raise ValueError("Invalid value for `sufficient_notice`, must not be `None`")  # noqa: E501
    ...
    def entitlement_failure_reasons(self, entitlement_failure_reasons):
        ...
        :type: list[str]
        """
        allowed_values = ["UnableToCalculateAwe", "AweLowerThanLel", "NotQualifiedInPreviousPiw", "ExceededMaximumEntitlementWeeksOfSsp", "ExceededMaximumDurationOfPiw", "SufficientNoticeNotGiven", "None"]  # noqa: E501
        if not set(entitlement_failure_reasons).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `entitlement_failure_reasons` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(entitlement_failure_reasons) - set(allowed_values))),  # noqa: E501
