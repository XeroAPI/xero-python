...
class Benefit(BaseModel):
    ...
    def __init__(self, id=None, name=None, category=None, liability_account_id=None, expense_account_id=None, standard_amount=None, percentage=None, calculation_type=None, current_record=None, subject_to_nic=None, subject_to_pension=None, subject_to_tax=None, is_calculating_on_qualifying_earnings=None, show_balance_to_employee=None):  # noqa: E501
