...
class EmployeeOpeningBalances(BaseModel):
    ...
    def __init__(self, statutory_adoption_pay=None, statutory_maternity_pay=None, statutory_paternity_pay=None, statutory_shared_parental_pay=None, statutory_sick_pay=None, prior_employee_number=None):  # noqa: E501
