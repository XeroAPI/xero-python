...
class EmployeeLeaveType(BaseModel):
    ...
    def __init__(self, leave_type_id=None, schedule_of_accrual=None, hours_accrued_annually=None, maximum_to_accrue=None, opening_balance=None, rate_accrued_hourly=None):  # noqa: E501
    ...
    def schedule_of_accrual(self, schedule_of_accrual):
        ...
        if schedule_of_accrual is None:
            raise ValueError("Invalid value for `schedule_of_accrual`, must not be `None`")  # noqa: E501
        allowed_values = ["BeginningOfCalendarYear", "OnAnniversaryDate", "EachPayPeriod", "OnHourWorked", "None"]  # noqa: E501
