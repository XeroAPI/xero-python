...
class PayRun(BaseModel):
    ...
    def __init__(self, pay_run_id=None, payroll_calendar_id=None, period_start_date=None, period_end_date=None, payment_date=None, total_cost=None, total_pay=None, pay_run_status=None, pay_run_type=None, calendar_type=None, posted_date_time=None, pay_slips=None):  # noqa: E501
    ...
    def pay_run_status(self, pay_run_status):
        ...
        if pay_run_status:
            if pay_run_status not in allowed_values:
                raise ValueError(
                    "Invalid value for `pay_run_status` ({0}), must be one of {1}"  # noqa: E501
                    .format(pay_run_status, allowed_values)
            )
    ...
    def pay_run_type(self, pay_run_type):
        ...
        :type: str
        """
        allowed_values = ["Scheduled", "Unscheduled", "EarlierYearUpdate", "None"]  # noqa: E501
        
        if pay_run_type:
            if pay_run_type not in allowed_values:
                raise ValueError(
                    "Invalid value for `pay_run_type` ({0}), must be one of {1}"  # noqa: E501
                    .format(pay_run_type, allowed_values)
            )
    ...
    def calendar_type(self, calendar_type):
        ...
        :type: str
        """
        allowed_values = ["Weekly", "Fortnightly", "FourWeekly", "Monthly", "Annual", "Quarterly", "None"]  # noqa: E501
