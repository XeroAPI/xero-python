...
class Plan(BaseModel):
    ...
    def __init__(self, id=None, name=None, status=None, subscription_items=None):  # noqa: E501
    ...
    def subscription_items(self, subscription_items):
        ...
        if subscription_items is None:
            raise ValueError("Invalid value for `subscription_items`, must not be `None`")  # noqa: E501
