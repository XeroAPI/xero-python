...
class AccountingApi(object):
    ...
    def create_manual_journal_history_record(
        ...
        """Allows you to create history record for a manual journal  # noqa: E501
        OAuth2 scope: accounting.transactions
        :param str xero_tenant_id: Xero identifier for Tenant (required)
    ...
    def get_manual_journals_history(
        ...
        """Allows you to retrieve history from a manual journal  # noqa: E501
        OAuth2 scope: accounting.transactions.read
        :param str xero_tenant_id: Xero identifier for Tenant (required)
        :param str manual_journal_id: Xero generated unique identifier for a manual journal (required)
        :param bool _return_http_data_only: return received data only
    ...
    def get_organisation_actions(
        ...
        """Retrieve a list of the key actions your app has permission to perform in the connected organisation.  # noqa: E501
        OAuth2 scope: accounting.settings.read
        :param str xero_tenant_id: Xero identifier for Tenant (required)
        :param bool _return_http_data_only: return received data only
        :param bool _preload_content: load received data in models
