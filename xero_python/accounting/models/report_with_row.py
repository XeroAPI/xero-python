...
class ReportWithRow(BaseModel):
    ...
    def __init__(self, report_id=None, report_name=None, report_title=None, report_type=None, report_titles=None, report_date=None, rows=None, updated_date_utc=None, fields=None):  # noqa: E501
