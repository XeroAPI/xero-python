...
class Prepayment(BaseModel):
    ...
    def __init__(self, type=None, contact=None, date=None, status=None, line_amount_types=None, line_items=None, sub_total=None, total_tax=None, total=None, reference=None, updated_date_utc=None, currency_code=None, prepayment_id=None, currency_rate=None, remaining_credit=None, allocations=None, payments=None, applied_amount=None, has_attachments=False, attachments=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["RECEIVE-PREPAYMENT", "SPEND-PREPAYMENT", "ARPREPAYMENT", "APPREPAYMENT", "None"]  # noqa: E501
