...
class Element(BaseModel):
    ...
    def __init__(self, validation_errors=None, batch_payment_id=None, bank_transaction_id=None, credit_note_id=None, contact_id=None, invoice_id=None, item_id=None, purchase_order_id=None):  # noqa: E501
