...
class ManualJournal(BaseModel):
    ...
    def __init__(self, narration=None, journal_lines=None, date=None, line_amount_types=None, status=None, url=None, show_on_cash_basis_reports=None, has_attachments=False, updated_date_utc=None, manual_journal_id=None, status_attribute_string=None, warnings=None, validation_errors=None, attachments=None):  # noqa: E501
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["DRAFT", "POSTED", "DELETED", "VOIDED", "ARCHIVED", "None"]  # noqa: E501
