...
class BankTransfer(BaseModel):
    ...
    def __init__(self, from_bank_account=None, to_bank_account=None, amount=None, date=None, bank_transfer_id=None, currency_rate=None, from_bank_transaction_id=None, to_bank_transaction_id=None, has_attachments=False, created_date_utc=None, validation_errors=None):  # noqa: E501
