...
class Invoice(BaseModel):
    ...
    def __init__(self, type=None, contact=None, line_items=None, date=None, due_date=None, line_amount_types=None, invoice_number=None, reference=None, branding_theme_id=None, url=None, currency_code=None, currency_rate=None, status=None, sent_to_contact=None, expected_payment_date=None, planned_payment_date=None, cis_deduction=None, cis_rate=None, sub_total=None, total_tax=None, total=None, total_discount=None, invoice_id=None, repeating_invoice_id=None, has_attachments=False, is_discounted=None, payments=None, prepayments=None, overpayments=None, amount_due=None, amount_paid=None, fully_paid_on_date=None, amount_credited=None, updated_date_utc=None, credit_notes=None, attachments=None, has_errors=False, status_attribute_string=None, validation_errors=None, warnings=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["ACCPAY", "ACCPAYCREDIT", "APOVERPAYMENT", "APPREPAYMENT", "ACCREC", "ACCRECCREDIT", "AROVERPAYMENT", "ARPREPAYMENT", "None"]  # noqa: E501
    ...
    def invoice_number(self, invoice_number):
        ...
        if invoice_number is not None and len(invoice_number) > 255:
            raise ValueError("Invalid value for `invoice_number`, "
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["DRAFT", "SUBMITTED", "DELETED", "AUTHORISED", "PAID", "VOIDED", "None"]  # noqa: E501
