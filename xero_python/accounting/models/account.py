...
class Account(BaseModel):
    ...
    def __init__(self, code=None, name=None, account_id=None, type=None, bank_account_number=None, status=None, description=None, bank_account_type=None, currency_code=None, tax_type=None, enable_payments_to_account=None, show_in_expense_claims=None, _class=None, system_account=None, reporting_code=None, reporting_code_name=None, has_attachments=False, updated_date_utc=None, add_to_watchlist=None, validation_errors=None):  # noqa: E501
    ...
    def name(self, name):
        ...
        if name is not None and len(name) > 150:
            raise ValueError("Invalid value for `name`, "
                             "length must be less than or equal to `150`")  # noqa: E501
    ...
    def bank_account_type(self, bank_account_type):
        ...
        :type: str
        """
        allowed_values = ["BANK", "CREDITCARD", "PAYPAL", "NONE", "", "None"]  # noqa: E501
    ...
    def _class(self, _class):
        ...
        :type: str
        """
        allowed_values = ["ASSET", "EQUITY", "EXPENSE", "LIABILITY", "REVENUE", "None"]  # noqa: E501
    ...
    def system_account(self, system_account):
        ...
        :type: str
        """
        allowed_values = ["DEBTORS", "CREDITORS", "BANKCURRENCYGAIN", "GST", "GSTONIMPORTS", "HISTORICAL", "REALISEDCURRENCYGAIN", "RETAINEDEARNINGS", "ROUNDING", "TRACKINGTRANSFERS", "UNPAIDEXPCLM", "UNREALISEDCURRENCYGAIN", "WAGEPAYABLES", "CISASSETS", "CISASSET", "CISLABOUR", "CISLABOUREXPENSE", "CISLABOURINCOME", "CISLIABILITY", "CISMATERIALS", "", "None"]  # noqa: E501
