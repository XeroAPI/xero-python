...
class Item(BaseModel):
    ...
    def __init__(self, code=None, inventory_asset_account_code=None, name=None, is_sold=None, is_purchased=None, description=None, purchase_description=None, purchase_details=None, sales_details=None, is_tracked_as_inventory=None, total_cost_pool=None, quantity_on_hand=None, updated_date_utc=None, item_id=None, status_attribute_string=None, validation_errors=None):  # noqa: E501
    ...
    def code(self, code):
        ...
        if code is not None and len(code) > 30:
            raise ValueError("Invalid value for `code`, "
                             "length must be less than or equal to `30`")  # noqa: E501
    ...
    def purchase_description(self, purchase_description):
        ...
        if purchase_description is not None and len(purchase_description) > 4000:
            raise ValueError("Invalid value for `purchase_description`, "
                             "length must be less than or equal to `4000`")  # noqa: E501
