...
class RepeatingInvoice(BaseModel):
    ...
    def __init__(self, type=None, contact=None, schedule=None, line_items=None, line_amount_types=None, reference=None, branding_theme_id=None, currency_code=None, status=None, sub_total=None, total_tax=None, total=None, repeating_invoice_id=None, id=None, has_attachments=False, attachments=None):  # noqa: E501
