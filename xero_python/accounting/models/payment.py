...
class Payment(BaseModel):
    ...
    def __init__(self, invoice=None, credit_note=None, prepayment=None, overpayment=None, invoice_number=None, credit_note_number=None, account=None, code=None, date=None, currency_rate=None, amount=None, bank_amount=None, reference=None, is_reconciled=None, status=None, payment_type=None, updated_date_utc=None, payment_id=None, batch_payment_id=None, bank_account_number=None, particulars=None, details=None, has_account=False, has_validation_errors=False, status_attribute_string=None, validation_errors=None):  # noqa: E501
    ...
    def payment_type(self, payment_type):
        ...
        :type: str
        """
        allowed_values = ["ACCRECPAYMENT", "ACCPAYPAYMENT", "ARCREDITPAYMENT", "APCREDITPAYMENT", "AROVERPAYMENTPAYMENT", "ARPREPAYMENTPAYMENT", "APPREPAYMENTPAYMENT", "APOVERPAYMENTPAYMENT", "None"]  # noqa: E501
