...
class Allocation(BaseModel):
    ...
    def __init__(self, invoice=None, overpayment=None, prepayment=None, credit_note=None, amount=None, date=None, status_attribute_string=None, validation_errors=None):  # noqa: E501
