...
class Receipt(BaseModel):
    ...
    def __init__(self, date=None, contact=None, line_items=None, user=None, reference=None, line_amount_types=None, sub_total=None, total_tax=None, total=None, receipt_id=None, status=None, receipt_number=None, updated_date_utc=None, has_attachments=False, url=None, validation_errors=None, warnings=None, attachments=None):  # noqa: E501
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["DRAFT", "SUBMITTED", "AUTHORISED", "DECLINED", "VOIDED", "None"]  # noqa: E501
