...
class PurchaseOrder(BaseModel):
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["DRAFT", "SUBMITTED", "AUTHORISED", "BILLED", "DELETED", "None"]  # noqa: E501
