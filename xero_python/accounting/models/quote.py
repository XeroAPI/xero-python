...
class Quote(BaseModel):
    ...
    def __init__(self, quote_id=None, quote_number=None, reference=None, terms=None, contact=None, line_items=None, date=None, date_string=None, expiry_date=None, expiry_date_string=None, status=None, currency_code=None, currency_rate=None, sub_total=None, total_tax=None, total=None, total_discount=None, title=None, summary=None, branding_theme_id=None, updated_date_utc=None, line_amount_types=None, status_attribute_string=None, validation_errors=None):  # noqa: E501
    ...
    def quote_number(self, quote_number):
        ...
        if quote_number is not None and len(quote_number) > 255:
            raise ValueError("Invalid value for `quote_number`, "
    ...
    def reference(self, reference):
        ...
        if reference is not None and len(reference) > 4000:
            raise ValueError("Invalid value for `reference`, "
                             "length must be less than or equal to `4000`")  # noqa: E501
    ...
    def terms(self, terms):
        ...
        if terms is not None and len(terms) > 4000:
            raise ValueError("Invalid value for `terms`, "
                             "length must be less than or equal to `4000`")  # noqa: E501
    ...
    def title(self, title):
        ...
        if title is not None and len(title) > 100:
            raise ValueError("Invalid value for `title`, "
                             "length must be less than or equal to `100`")  # noqa: E501
    ...
    def summary(self, summary):
        ...
        if summary is not None and len(summary) > 3000:
            raise ValueError("Invalid value for `summary`, "
                             "length must be less than or equal to `3000`")  # noqa: E501
