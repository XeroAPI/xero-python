...
class Employee(BaseModel):
    ...
    def __init__(self, employee_id=None, status=None, first_name=None, last_name=None, external_link=None, updated_date_utc=None, status_attribute_string=None, validation_errors=None):  # noqa: E501
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["ACTIVE", "ARCHIVED", "GDPRREQUEST", "DELETED", "None"]  # noqa: E501
