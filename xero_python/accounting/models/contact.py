...
class Contact(BaseModel):
    ...
    def contact_number(self, contact_number):
        ...
        if contact_number is not None and len(contact_number) > 50:
            raise ValueError("Invalid value for `contact_number`, "
    ...
    def account_number(self, account_number):
        ...
        if account_number is not None and len(account_number) > 50:
            raise ValueError("Invalid value for `account_number`, "
                             "length must be less than or equal to `50`")  # noqa: E501
    ...
    def first_name(self, first_name):
        ...
        if first_name is not None and len(first_name) > 255:
            raise ValueError("Invalid value for `first_name`, "
                             "length must be less than or equal to `255`")  # noqa: E501
    ...
    def last_name(self, last_name):
        ...
        if last_name is not None and len(last_name) > 255:
            raise ValueError("Invalid value for `last_name`, "
                             "length must be less than or equal to `255`")  # noqa: E501
    ...
    def email_address(self, email_address):
        ...
        if email_address is not None and len(email_address) > 255:
            raise ValueError("Invalid value for `email_address`, "
                             "length must be less than or equal to `255`")  # noqa: E501
    ...
    def tax_number(self, tax_number):
        ...
        if tax_number is not None and len(tax_number) > 50:
            raise ValueError("Invalid value for `tax_number`, "
                             "length must be less than or equal to `50`")  # noqa: E501
