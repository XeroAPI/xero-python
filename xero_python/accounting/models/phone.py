...
class Phone(BaseModel):
    ...
    def phone_type(self, phone_type):
        ...
        :type: str
        """
        allowed_values = ["DEFAULT", "DDI", "MOBILE", "FAX", "OFFICE", "None"]  # noqa: E501
    ...
    def phone_number(self, phone_number):
        ...
        if phone_number is not None and len(phone_number) > 50:
            raise ValueError("Invalid value for `phone_number`, "
    ...
    def phone_area_code(self, phone_area_code):
        ...
        if phone_area_code is not None and len(phone_area_code) > 10:
            raise ValueError("Invalid value for `phone_area_code`, "
                             "length must be less than or equal to `10`")  # noqa: E501
    ...
    def phone_country_code(self, phone_country_code):
        ...
        if phone_country_code is not None and len(phone_country_code) > 20:
            raise ValueError("Invalid value for `phone_country_code`, "
                             "length must be less than or equal to `20`")  # noqa: E501
