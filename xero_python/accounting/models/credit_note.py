...
class CreditNote(BaseModel):
    ...
    def __init__(self, type=None, contact=None, date=None, due_date=None, status=None, line_amount_types=None, line_items=None, sub_total=None, total_tax=None, total=None, cis_deduction=None, cis_rate=None, updated_date_utc=None, currency_code=None, fully_paid_on_date=None, credit_note_id=None, credit_note_number=None, reference=None, sent_to_contact=None, currency_rate=None, remaining_credit=None, allocations=None, applied_amount=None, payments=None, branding_theme_id=None, status_attribute_string=None, has_attachments=False, has_errors=False, validation_errors=None, warnings=None):  # noqa: E501
