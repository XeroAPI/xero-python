...
class BatchPayment(BaseModel):
    ...
    def __init__(self, account=None, reference=None, particulars=None, code=None, details=None, narrative=None, batch_payment_id=None, date_string=None, date=None, amount=None, payments=None, type=None, status=None, total_amount=None, updated_date_utc=None, is_reconciled=None, validation_errors=None):  # noqa: E501
    ...
    def particulars(self, particulars):
        ...
        if particulars is not None and len(particulars) > 12:
            raise ValueError("Invalid value for `particulars`, "
                             "length must be less than or equal to `12`")  # noqa: E501
    ...
    def narrative(self, narrative):
        ...
        if narrative is not None and len(narrative) > 18:
            raise ValueError("Invalid value for `narrative`, "
                             "length must be less than or equal to `18`")  # noqa: E501
