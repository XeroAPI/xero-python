...
class TimeEntry(BaseModel):
    ...
    def __init__(self, time_entry_id=None, user_id=None, project_id=None, task_id=None, date_utc=None, date_entered_utc=None, duration=None, description=None, status=None):  # noqa: E501
