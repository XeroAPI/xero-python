...
class TimeEntryCreateOrUpdate(BaseModel):
    ...
    def __init__(self, user_id=None, task_id=None, date_utc=None, duration=None, description=None):  # noqa: E501
    ...
    def date_utc(self, date_utc):
        ...
        """
        if date_utc is None:
            raise ValueError("Invalid value for `date_utc`, must not be `None`")  # noqa: E501
