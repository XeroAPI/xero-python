...
class EarningsLine(BaseModel):
    ...
    def __init__(self, earnings_line_id=None, earnings_rate_id=None, display_name=None, rate_per_unit=None, number_of_units=None, fixed_amount=None, amount=None, is_linked_to_timesheet=None, is_average_daily_pay_rate=None, is_system_generated=None):  # noqa: E501
