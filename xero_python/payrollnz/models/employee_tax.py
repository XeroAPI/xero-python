...
class EmployeeTax(BaseModel):
    ...
    def __init__(self, ird_number=None, tax_code=None, special_tax_rate_percentage=None, has_special_student_loan_rate=None, special_student_loan_rate_percentage=None, is_eligible_for_kiwi_saver=None, esct_rate_percentage=None, kiwi_saver_contributions=None, kiwi_saver_employee_contribution_rate_percentage=None, kiwi_saver_employer_contribution_rate_percentage=None, kiwi_saver_employer_salary_sacrifice_contribution_rate_percentage=None, kiwi_saver_opt_out_date=None, kiwi_saver_contribution_holiday_end_date=None, has_student_loan_balance=None, student_loan_balance=None, student_loan_as_at=None):  # noqa: E501
        ...
        if kiwi_saver_employer_salary_sacrifice_contribution_rate_percentage is not None:
            self.kiwi_saver_employer_salary_sacrifice_contribution_rate_percentage = kiwi_saver_employer_salary_sacrifice_contribution_rate_percentage
    ...
    def kiwi_saver_contributions(self, kiwi_saver_contributions):
        ...
        :type: str
        """
        allowed_values = ["MakeContributions", "OptOut", "OnAContributionsHoliday", "OnASavingsSuspension", "NotCurrentlyAKiwiSaverMember", "None"]  # noqa: E501
        
        if kiwi_saver_contributions:
            if kiwi_saver_contributions not in allowed_values:
                raise ValueError(
                    "Invalid value for `kiwi_saver_contributions` ({0}), must be one of {1}"  # noqa: E501
                    .format(kiwi_saver_contributions, allowed_values)
            )
    ...
    def kiwi_saver_employer_salary_sacrifice_contribution_rate_percentage(self, kiwi_saver_employer_salary_sacrifice_contribution_rate_percentage):
        ...
        self._kiwi_saver_employer_salary_sacrifice_contribution_rate_percentage = kiwi_saver_employer_salary_sacrifice_contribution_rate_percentage
