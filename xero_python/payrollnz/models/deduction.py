...
class Deduction(BaseModel):
    ...
    def __init__(self, deduction_id=None, deduction_name=None, deduction_category=None, liability_account_id=None, current_record=None, standard_amount=None):  # noqa: E501
    ...
    def deduction_category(self, deduction_category):
        ...
        if deduction_category is None:
            raise ValueError("Invalid value for `deduction_category`, must not be `None`")  # noqa: E501
        allowed_values = ["PayrollGiving", "KiwiSaverVoluntaryContributions", "Superannuation", "NzOther", "None"]  # noqa: E501
