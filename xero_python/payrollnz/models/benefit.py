...
class Benefit(BaseModel):
    ...
    def __init__(self, id=None, name=None, category=None, liability_account_id=None, expense_account_id=None, calculation_type_nz=None, standard_amount=None, percentage=None, company_max=None, current_record=None):  # noqa: E501
    ...
    def calculation_type_nz(self, calculation_type_nz):
        ...
        :type: str
        """
        allowed_values = ["FixedAmount", "PercentageOfTaxableEarnings", "None"]  # noqa: E501
        
        if calculation_type_nz:
            if calculation_type_nz not in allowed_values:
                raise ValueError(
                    "Invalid value for `calculation_type_nz` ({0}), must be one of {1}"  # noqa: E501
                    .format(calculation_type_nz, allowed_values)
            )
