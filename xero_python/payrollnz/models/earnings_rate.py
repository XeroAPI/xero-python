...
class EarningsRate(BaseModel):
    ...
    def earnings_type(self, earnings_type):
        ...
        allowed_values = ["Allowance", "Backpay", "Bonus", "Commission", "DiscretionaryPayments", "HolidayPay", "LumpSum", "OtherEarnings", "OtherGrossEarnings", "OvertimeEarnings", "RegularEarnings", "SalarySacrificeForKiwiSaver", "Tips(Direct)", "Tips(Non-Direct)", "WithholdingIncome", "None"]  # noqa: E501
