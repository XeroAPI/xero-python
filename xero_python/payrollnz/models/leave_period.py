...
class LeavePeriod(BaseModel):
    ...
    def __init__(self, period_start_date=None, period_end_date=None, number_of_units=None, period_status=None):  # noqa: E501
    ...
    def period_status(self, period_status):
        ...
        if period_status:
            if period_status not in allowed_values:
                raise ValueError(
                    "Invalid value for `period_status` ({0}), must be one of {1}"  # noqa: E501
                    .format(period_status, allowed_values)
            )
