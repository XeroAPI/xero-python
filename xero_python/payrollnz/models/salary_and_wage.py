...
class SalaryAndWage(BaseModel):
    ...
    def __init__(self, salary_and_wages_id=None, earnings_rate_id=None, number_of_units_per_week=None, rate_per_unit=None, number_of_units_per_day=None, days_per_week=None, effective_from=None, annual_salary=None, status=None, payment_type=None):  # noqa: E501
    ...
    def earnings_rate_id(self, earnings_rate_id):
        ...
        if earnings_rate_id is None:
            raise ValueError("Invalid value for `earnings_rate_id`, must not be `None`")  # noqa: E501
    ...
    def number_of_units_per_week(self, number_of_units_per_week):
        ...
        if number_of_units_per_week is None:
            raise ValueError("Invalid value for `number_of_units_per_week`, must not be `None`")  # noqa: E501
    ...
    def number_of_units_per_day(self, number_of_units_per_day):
        ...
        if number_of_units_per_day is None:
            raise ValueError("Invalid value for `number_of_units_per_day`, must not be `None`")  # noqa: E501
    ...
    def annual_salary(self, annual_salary):
        ...
        if annual_salary is None:
            raise ValueError("Invalid value for `annual_salary`, must not be `None`")  # noqa: E501
