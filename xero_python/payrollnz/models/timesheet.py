...
class Timesheet(BaseModel):
    ...
    def __init__(self, timesheet_id=None, payroll_calendar_id=None, employee_id=None, start_date=None, end_date=None, status=None, total_hours=None, updated_date_utc=None, timesheet_lines=None):  # noqa: E501
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["Draft", "Approved", "Completed", "Requested", "None"]  # noqa: E501
