...
class Reimbursement(BaseModel):
    ...
    def __init__(self, reimbursement_id=None, name=None, account_id=None, current_record=None, reimbursement_category=None, calculation_type=None, standard_amount=None, standard_type_of_units=None, standard_rate_per_unit=None):  # noqa: E501
    ...
    def reimbursement_category(self, reimbursement_category):
        ...
        if reimbursement_category:
            if reimbursement_category not in allowed_values:
                raise ValueError(
                    "Invalid value for `reimbursement_category` ({0}), must be one of {1}"  # noqa: E501
                    .format(reimbursement_category, allowed_values)
            )
    ...
    def standard_type_of_units(self, standard_type_of_units):
        ...
        if standard_type_of_units:
            if standard_type_of_units not in allowed_values:
                raise ValueError(
                    "Invalid value for `standard_type_of_units` ({0}), must be one of {1}"  # noqa: E501
                    .format(standard_type_of_units, allowed_values)
            )
