...
class SuperLine(BaseModel):
    ...
    def __init__(self, super_membership_id=None, contribution_type=None, calculation_type=None, minimum_monthly_earnings=None, expense_account_code=None, liability_account_code=None, percentage=None, amount=None):  # noqa: E501
