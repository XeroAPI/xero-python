...
class DeductionLine(BaseModel):
    ...
    def __init__(self, deduction_type_id=None, calculation_type=None, amount=None, percentage=None, number_of_units=None):  # noqa: E501
    ...
    def deduction_type_id(self, deduction_type_id):
        ...
        if deduction_type_id is None:
            raise ValueError("Invalid value for `deduction_type_id`, must not be `None`")  # noqa: E501
