...
class EarningsLine(BaseModel):
    ...
    def __init__(self, earnings_rate_id=None, calculation_type=None, annual_salary=None, number_of_units_per_week=None, rate_per_unit=None, normal_number_of_units=None, amount=None, number_of_units=None, fixed_amount=None):  # noqa: E501
