...
class SuperMembership(BaseModel):
    ...
    def __init__(self, super_membership_id=None, super_fund_id=None, employee_number=None):  # noqa: E501
    ...
    def super_fund_id(self, super_fund_id):
        ...
        if super_fund_id is None:
            raise ValueError("Invalid value for `super_fund_id`, must not be `None`")  # noqa: E501
