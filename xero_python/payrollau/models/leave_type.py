...
class LeaveType(BaseModel):
    ...
    def __init__(self, name=None, type_of_units=None, leave_type_id=None, normal_entitlement=None, leave_loading_rate=None, updated_date_utc=None, is_paid_leave=None, show_on_payslip=None, current_record=None):  # noqa: E501
