...
class LeaveLine(BaseModel):
    ...
    def __init__(self, leave_type_id=None, calculation_type=None, entitlement_final_pay_payout_type=None, employment_termination_payment_type=None, include_superannuation_guarantee_contribution=None, number_of_units=None, annual_number_of_units=None, full_time_number_of_units_per_period=None):  # noqa: E501
