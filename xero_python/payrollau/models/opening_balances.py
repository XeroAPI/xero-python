...
class OpeningBalances(BaseModel):
    ...
    def __init__(self, opening_balance_date=None, tax=None, earnings_lines=None, deduction_lines=None, super_lines=None, reimbursement_lines=None, leave_lines=None):  # noqa: E501
