...
class SuperFund(BaseModel):
    ...
    def __init__(self, super_fund_id=None, type=None, name=None, abn=None, bsb=None, account_number=None, account_name=None, electronic_service_address=None, employer_number=None, spin=None, usi=None, updated_date_utc=None, validation_errors=None):  # noqa: E501
