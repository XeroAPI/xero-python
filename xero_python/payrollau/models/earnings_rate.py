...
class EarningsRate(BaseModel):
    ...
    def __init__(self, name=None, account_code=None, type_of_units=None, is_exempt_from_tax=None, is_exempt_from_super=None, is_reportable_as_w1=None, earnings_type=None, earnings_rate_id=None, rate_type=None, rate_per_unit=None, multiplier=None, accrue_leave=None, amount=None, employment_termination_payment_type=None, updated_date_utc=None, current_record=None, allowance_type=None):  # noqa: E501
    ...
    def type_of_units(self, type_of_units):
        ...
        if type_of_units is not None and len(type_of_units) > 50:
            raise ValueError("Invalid value for `type_of_units`, "
