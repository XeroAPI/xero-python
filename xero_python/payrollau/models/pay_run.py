...
class PayRun(BaseModel):
    ...
    def __init__(self, payroll_calendar_id=None, pay_run_id=None, pay_run_period_start_date=None, pay_run_period_end_date=None, pay_run_status=None, payment_date=None, payslip_message=None, updated_date_utc=None, payslips=None, wages=None, deductions=None, tax=None, super=None, reimbursement=None, net_pay=None, validation_errors=None):  # noqa: E501
    ...
    def payroll_calendar_id(self, payroll_calendar_id):
        ...
        if payroll_calendar_id is None:
            raise ValueError("Invalid value for `payroll_calendar_id`, must not be `None`")  # noqa: E501
