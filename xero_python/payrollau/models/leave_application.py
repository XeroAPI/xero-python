...
class LeaveApplication(BaseModel):
    ...
    def __init__(self, leave_application_id=None, employee_id=None, leave_type_id=None, title=None, start_date=None, end_date=None, description=None, leave_periods=None, updated_date_utc=None, validation_errors=None):  # noqa: E501
