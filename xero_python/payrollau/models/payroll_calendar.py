...
class PayrollCalendar(BaseModel):
    ...
    def __init__(self, name=None, calendar_type=None, start_date=None, payment_date=None, payroll_calendar_id=None, updated_date_utc=None, reference_date=None, validation_errors=None):  # noqa: E501
