...
class Payslip(BaseModel):
    ...
    def __init__(self, employee_id=None, payslip_id=None, first_name=None, last_name=None, wages=None, deductions=None, tax=None, super=None, reimbursements=None, net_pay=None, earnings_lines=None, leave_earnings_lines=None, timesheet_earnings_lines=None, deduction_lines=None, leave_accrual_lines=None, reimbursement_lines=None, superannuation_lines=None, tax_lines=None, updated_date_utc=None):  # noqa: E501
