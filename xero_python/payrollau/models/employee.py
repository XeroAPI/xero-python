...
class Employee(BaseModel):
    ...
    def __init__(self, first_name=None, last_name=None, date_of_birth=None, home_address=None, start_date=None, title=None, middle_names=None, email=None, gender=None, phone=None, mobile=None, twitter_user_name=None, is_authorised_to_approve_leave=None, is_authorised_to_approve_timesheets=None, job_title=None, classification=None, ordinary_earnings_rate_id=None, payroll_calendar_id=None, employee_group_name=None, employee_id=None, termination_date=None, termination_reason=None, bank_accounts=None, pay_template=None, opening_balances=None, tax_declaration=None, leave_balances=None, leave_lines=None, super_memberships=None, status=None, updated_date_utc=None, validation_errors=None):  # noqa: E501
