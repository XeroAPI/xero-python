...
class PayslipSummary(BaseModel):
    ...
    def __init__(self, employee_id=None, payslip_id=None, first_name=None, last_name=None, employee_group=None, wages=None, deductions=None, tax=None, super=None, reimbursements=None, net_pay=None, updated_date_utc=None):  # noqa: E501
