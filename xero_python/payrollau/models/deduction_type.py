...
class DeductionType(BaseModel):
    ...
    def __init__(self, name=None, account_code=None, reduces_tax=None, reduces_super=None, is_exempt_from_w1=None, deduction_type_id=None, updated_date_utc=None, deduction_category=None, current_record=None):  # noqa: E501
